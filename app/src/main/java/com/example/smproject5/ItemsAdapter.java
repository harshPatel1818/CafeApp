...
class ItemsAdapter extends RecyclerView.Adapter<ItemsAdapter.ItemsHolder>{
    ...
    private ArrayList<MenuItem> items; //need the data binding to each row of RecyclerView

    public ItemsAdapter(Context context, ArrayList<MenuItem> items) {
    ...
    public void onBindViewHolder(@NonNull ItemsHolder holder, int position) {
        ...
        //holder.tv_price.setText(items.get(position).toString());
